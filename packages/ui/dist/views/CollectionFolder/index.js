...
function CollectionFolderViewInContext(props) {
  ...
  let t5;
  if ($[17] !== dragOverlayItem || $[18] !== selectedItemKeys.size) {
    t5 = selectedItemKeys.size > 0 && dragOverlayItem && _jsx(DragOverlaySelection, {
      item: dragOverlayItem,
      selectedCount: selectedItemKeys.size
    });
    $[17] = dragOverlayItem;
    $[18] = selectedItemKeys.size;
    $[19] = t5;
  } else {
    t5 = $[19];
  }
    ...
    children: [_jsx(DndEventListener, {
      ...
      children: [BeforeFolderList, _jsxs(Gutter, {
        ...
        children: [_jsx(ListHeader, {
          ...
          }, "list-selection"), config.folders && collectionConfig.folders && _jsxs(Fragment, {
            children: [_jsx(DefaultListPill, {
              collectionConfig,
              viewType: "folders"
            }, "list-header-default-button"), _jsx(ByFolderPill, {
              collectionConfig,
              folderCollectionSlug,
              viewType: "folders"
            }, "list-header-by-folder-button")]
          }, "list-header-folder-view-buttons"), collectionConfig.trash && _jsx(TrashPill, {
            collectionConfig,
            viewType: "folders"
          }, "list-header-trash-button")].filter(Boolean),
