...
export function DefaultEditView({
  ...
  }, [reportUpdate, id, entitySlug, user, collectionSlug, userSlug, incrementVersionCount, updateSavedDocumentData, onSaveFromContext, redirectAfterCreate, isEditing, depth, getDocPermissions, globalSlug, autosaveEnabled, refreshCookieAsync, adminRoute, locale, router, resetUploadEdits, getDocPreferences, getFormState, docPermissions, operation, schemaPathSegments, isLockingEnabled, setDocumentIsLocked, startRouteTransition]);
    ...
    children: /*#__PURE__*/_jsx(OperationProvider, {
      ...
      children: /*#__PURE__*/_jsxs(Form, {
        ...
        children: [isInDrawer && /*#__PURE__*/_jsx(DocumentDrawerHeader, {
          ...
          onTakeOver: () => handleTakeOver(id, collectionSlug, globalSlug, user, false, updateDocumentEditor, setCurrentEditor, documentLockState, isLockingEnabled),
          ...
          onRestore: onRestore,
          onSave: onSave,
          onTakeOver: () => handleTakeOver(id, collectionSlug, globalSlug, user, true, updateDocumentEditor, setCurrentEditor, documentLockState, isLockingEnabled, setIsReadOnlyForIncomingUser),
