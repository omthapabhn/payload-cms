...
export const CollectionListHeader = ({
  ...
  return /*#__PURE__*/_jsx(ListHeader, {
    Actions: [!smallBreak && !isGroupingBy && /*#__PURE__*/_jsx(ListSelection, {
      ...
      viewType: viewType
    }, "list-selection"), (collectionConfig.folders && config.folders || isTrashEnabled) && /*#__PURE__*/_jsx(DefaultListPill, {
      collectionConfig: collectionConfig,
      viewType: viewType
    }, "list-header-default-button"), collectionConfig.folders && config.folders && /*#__PURE__*/_jsx(ByFolderPill, {
      collectionConfig: collectionConfig,
      folderCollectionSlug: config.folders.slug,
      viewType: viewType
    }, "list-header-by-folder-button"), isTrashEnabled && /*#__PURE__*/_jsx(TrashPill, {
      collectionConfig: collectionConfig,
      viewType: viewType
